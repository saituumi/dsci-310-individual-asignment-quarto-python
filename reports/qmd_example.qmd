...
![Horse populations for all provinces in Canada from 1906 - 1972.](../results/horse_pops_plot.png){#fig-hs1 width=60%}
...
![Horse populations for the province with the largest standard deviation](../results/horse_pops_plot_largest_sd.png){#fig-hs2 width=40%}

@fig-hs2: Horse populations for the province with the largest standard deviation

```{python}
largest_sd_prov = 'Alberta'
```
