...
Additionally, note that in Table 1 we consider the sample standard deviation of the number of horses during the same time span as @fig-hs1.

![](../results/horse_pops_plot_largest_sd.png){#fig-hs2 width=60%}
